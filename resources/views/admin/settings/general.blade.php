                                ...
                                <div class="card-body">
                                    <form method="POST" action="/admin/settings/general">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputaddress2" type="text" class="form-control form-control-lg @error('address_2') is-invalid @enderror" name="address_2" value="{{ old('address_1', $general_setting->address_2) }}" autocomplete="address_2" autofocus placeholder="Apt/Suite/Building">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input id="inputcity" type="text" class="form-control form-control-lg @error('city') is-invalid @enderror" name="city" value="{{ old('city', $general_setting->address_2) }}" required autocomplete="city" autofocus placeholder="City">
                                         ...
                                         <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            <label for="inputzipcode">Enter Zip Code</label>
                                            ...
                                            <input id="inputphonenumber" type="text" class="form-control form-control-lg @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number', $general_setting->phone_number) }}" required autocomplete="phone_number" autofocus placeholder="Phone Number">
