                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> Last 30 Days
                                             </li>
                                        </ol>
                                    </nav>
                                </div>
                                            ...
                                            <table class="table">
                                                ...
                                                @foreach ($latestReservations as $reservation )
                                                    <tr>
                                                        ...
                                                        <span class="badge-dot badge-success mr-1"></span>Booth</td>
                                                        @else 
                                                        <span class="badge-dot badge-brand mr-1"></span>Bar</td>
                                                         @endif
                                                    </tr>
                                                     @endforeach
                                                     <tr>
